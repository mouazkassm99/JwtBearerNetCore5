            ...
            services.AddAuthentication(options =>
                ...
                .AddJwtBearer(options =>
                {
                    options.TokenValidationParameters = new TokenValidationParameters
                    {
                        ...
                        IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF32.GetBytes("1234567891234567"))
                    };
                });
            services.AddControllers();
            
            
            services.AddSwaggerGen(c => { c.SwaggerDoc("v1", new OpenApiInfo {Title = "JwtToken", Version = "v1"}); });
        }
